...
class <%= namespaces if namespaced? %><%= singular_table_name.camelize %>Controller < ApplicationController
    ...
    def create
        <%= singular_table_name %>_form = <%= namespaces if namespaced? %><%= singular_table_name.camelize %>Form.new(<%= singular_table_name %>_form_params)
